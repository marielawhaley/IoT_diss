 ...
 * MQTTV3ASSample MQTT v3 Asynchronous SSL Client application
 *
 * Version: @(#) MQMBID sn=p000-L130522.1 su=_M3QBMsMbEeK31Ln-reX3cg pn=com.ibm.mq.mqxr.listener/SDK/clients/c/samples/MQTTV3ASSample.c
 *
 *   <copyright 
...
int main(int argc, char** argv)
{
	...
	if (options.clientKey != NULL)
		conn_opts.ssl->keyStore = options.clientKey;
